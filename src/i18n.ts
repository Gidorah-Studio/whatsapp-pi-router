...
const fallback = {
    ...
    "menu.recents.contact.linkCrmLead": "Link CRM Lead ID",
    "menu.recents.contact.clearIdentity": "Clear CRM Identity Link",
    ...
    "menu.recents.identity.enterPhone": "Enter known CRM phone for {number}:",
    "menu.recents.identity.enterEmail": "Enter known CRM email for {number}:",
    "menu.recents.identity.enterCrmLead": "Enter known CRM lead ID for {number}:",
    ...
    "menu.recents.identity.invalidCrmLead": "Enter a positive CRM lead ID.",
    "menu.recents.identity.phoneLinked": "Linked CRM phone {phone}",
    "menu.recents.identity.emailLinked": "Linked CRM email {email}",
    "menu.recents.identity.crmLeadLinked": "Linked CRM lead #{crmLeadId}",
    "menu.recents.identityCleared": "Cleared CRM identity link for {number}",
